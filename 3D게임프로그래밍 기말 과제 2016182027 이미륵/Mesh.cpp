...
CMesh::CMesh(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList, const char* pstrFileName)
{
	if (pstrFileName)
	{
		if (strstr(pstrFileName, "bin"))
			LoadMeshFromFile(pd3dDevice, pd3dCommandList, pstrFileName);
		else
			LoadtextMeshFromFile(pd3dDevice, pd3dCommandList, pstrFileName);
	}
}
...
void CMesh::LoadtextMeshFromFile(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList, const char* pstrFileName)
{
	char pstrToken[64] = { '\0' };
