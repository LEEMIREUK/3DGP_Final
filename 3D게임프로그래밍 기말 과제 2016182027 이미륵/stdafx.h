...
namespace Vector3
{
	...
	{
		return(Angle((XMFLOAT3&)XMLoadFloat3(&xmf3Vector1), (XMFLOAT3&)XMLoadFloat3(&xmf3Vector2)));
	}
	...
	{
		return(TransformCoord((XMFLOAT3&)xmf3Vector, (XMFLOAT4X4&)XMLoadFloat4x4(&xmmtx4x4Matrix)));
	}
}
